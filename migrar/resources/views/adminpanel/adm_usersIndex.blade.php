...
<ul class="nav nav-pills">
  ...
  <li><a href="{{ URL::to('/admin_users/create') }}">Neue Benutzer addieren <span class="glyphicon glyphicon-plus" style="margin-left:10px;"></a></li>
...
<div class="table-responsive">
  <table class="table KD_ADM_ListTable">
    <thead>
      <tr>
        <th>ID</th>
        <th>Name</th>
